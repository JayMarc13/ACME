  ...
  export class AgregarEditarOfficeComponent {
    ...
    Operacion: string = 'Agregar';
          ...
          constructor(private _officeService: OfficeService, private fb: FormBuilder, private _snackBar: MatSnackBar, private router: Router, private aRoute: ActivatedRoute) {
